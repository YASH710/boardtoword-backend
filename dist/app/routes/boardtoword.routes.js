...
const BoardToWordController = __importStar(require("../controllers/boardtoword.controller"));
...
router.post("/upload-template", TemplateHelper_1.TemplateHelper.uploadUsingMulter.single('file'), (req, res) => {
